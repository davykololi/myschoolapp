...
class AttachTeacherToClubController extends Controller
{
    protected $clubRepo;
    /**
    ...
    public function attachTeacherToClub(Request $request,$id)
    {
    	...
    	$club->teachers()->syncWithoutDetaching($teachers);
