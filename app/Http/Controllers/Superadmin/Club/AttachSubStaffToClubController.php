...
class AttachSubStaffToClubController extends Controller
{
    protected $clubRepo;
    /**
    ...
    public function attachSubStaffToClub(Request $request,$id)
    {
    	...
    	$club->subordinates()->syncWithoutDetaching($subordinates);
