...
class AttachTeacherToStreamController extends Controller
{
    /**
    ...
    public function attachTeacherToStream(Request $request,$id)
    {
    	...
    	$stream->teachers()->syncWithoutDetaching($teachers);
