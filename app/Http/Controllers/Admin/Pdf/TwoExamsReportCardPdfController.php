...
class TwoExamsReportCardPdfController extends Controller
{
    /**
    ...
    public function twoExamsReportCard(Request $request)
    {
        ...
        $histAndGovernmentAvg = Stat::mean([$examOneMark->history_and_government,$examTwoMark->history_and_government]);
        ...
        //Get History And Government GPA 
        ...
        $pdf = PDF::loadView('admin.pdf.twoexams_reportcard',$data)->setOptions(['dpi'=>150,'defaultFont'=>'sans-serif','isRemoteEnabled' => true,'isHtml5ParserEnabled' => true])->setPaper('a4','potrait');
