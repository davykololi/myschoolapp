...
namespace App\Http\Controllers\Admin\RoyceSMS;
...
class RoyceSMSController extends Controller
{
    /**
    ...
    public function messages()
    {
        ...
        // dd($messages);
        return view('admin.royceviews.textmessages', ['messages' => $messages]);
    }
    ...
    {
        return view('admin.royceviews.base');
    }
    ...
    public function contacts()
    {
        ...
        return view('admin.royceviews.contacts',['contacts'=>$contacts,'status'=>'My Contact','groups'=>$groups]);
    ...
    public function contactsGroup()
    {
        ...
        // dd($groups);
        // dd($apikey);
        return view('admin.royceviews.contactgroups',['groups'=>$groups]);
    }
    ...
    public function editGroup($id)
    {
        ...
        // $groups= ContactGroup::withCount('contacts')->get();
        return view('admin.royceviews.editgroup',['group'=>$group]);
    } 
    ...
    public function editContactGroup(Request $request)
    {
        ...
        $group->save();
        toastr()->success(ucwords('Contact group updated successfully'));

        return redirect('admin/roycesms/contacts-group');
    }
    ...
    public function saveContactsGroup(Request $request)
    {
        ...
        $group->save();
        toastr()->success(ucwords('Contact group saved successfully'));
    ...
    {
        return view('admin.royceviews.singletext');
    }
    ...
    public function sendSingleText(Request $request)
    {
        ...
        return redirect('admin/roycesms/dashboard')->with('status','SMS sent successfully');
    }
    ...
    public function contactsText()
    {
        ...
        return view('admin.royceviews.contacttext',['contacts'=>$contacts]);
    }
    ...
    public function groupText()
    {
        ...
        return view('admin.royceviews.grouptext',['groups'=>$groups]);
    }
    ...
    public function getDeliveryReport()
    {
        ...
        return view('admin.royceviews.deliveryreport',['status'=>'Enter message ID from outbox']);
    }
    ...
    public function pDeliveryReport(Request $request)
    {
        ...
        $response = Curl::to($url)
            ...
            if(!$response){
                return view('admin.royceviews.deliveryreport',['status'=>'Check the message id and try again']);
            }
            ...
            return view('admin.royceviews.deliveryreport',['status'=>'Delivery Report','report'=>$res]);
    }

    public function setWebhook()
    {
        return view('admin.royceviews.webhook',['status'=>'Set Web hook URL']);
