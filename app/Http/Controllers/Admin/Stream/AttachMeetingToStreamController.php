...
class AttachMeetingToStreamController extends Controller
{
    /**
    ...
    public function attachMeetingToStream(Request $request,$id)
    {
    	...
    	$stream->meetings()->syncWithoutDetaching($meetings);
