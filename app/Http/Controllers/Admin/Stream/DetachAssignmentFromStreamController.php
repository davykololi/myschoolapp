...
class DetachAssignmentFromStreamController extends Controller
{
    /**
    ...
    public function detachAssignmentFromStream(Request $request,$id)
    {
    	...
    	$stream->assignments()->detach($assignments);
