...
class TeacherThreeExamsReportcardFormController extends Controller
{
    ...
    public function threeExamsReportCardForm()
    {
        ...
        return view('teacher.pdf.threeexams_reportcardform',compact('classes','streams','exams','students','currentTerm','currentYear'));
    }
}
