...
class TeacherReportcardTotalsController extends Controller
{
        /**
    ...
    public function twoExamsClassTotalsStore(Request $request)
    {
        ...
        if($classStudents->isNotEmpty()){
            foreach($classStudents as $student){
                ...
                Session::push("clsT",$data);
            }

            return back()->withSuccess($class->name." "."report card positions set successfully");
        } else {
            return back()->withError($class->name." "."has no students at the moment");
        }
    }
    ...
    public function threeExamsClassTotalsStore(Request $request)
    {
        ...
        if($classStudents->isNotEmpty()){
            ...
            return back()->withError($class->name." "."has no students at he moment!");
        }
    }
    ...
    public function twoExamsStreamTotalsStore(Request $request)
    {
        ...
        if(($yearId === null) || ($termId === null) ||($streamId === null)){
            return back()->withError('Please fill in all the required details first before you proceed!');
        }
        ...
        if(session()->exists("strmT")){
            session()->forget("strmT");
        }
        ...
        if($streamStudents->isNotEmpty()){
            foreach($streamStudents as $student){
                ...
                Session::push("strmT",$data);
            }

            return back()->withSuccess($stream->name." "."report card positions set successfully");
        } else {
