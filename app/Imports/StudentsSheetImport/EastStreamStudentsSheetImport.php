...
class EastStreamStudentsSheetImport implements OnEachRow, WithHeadingRow,WithChunkReading,WithUpserts
{
    protected $dormId, $intakeId,$eastId;
    /**
     * Create a new controller instance.
     *
     * @return void
     */
    public function __construct($dormId, $intakeId,$eastId)
    {
        $this->dormId = $dormId;
    ...
    */
    ...
    {   
        ...
        $usertb = User::updateOrCreate($user);
        ...
        $studenttb = Student::updateOrCreate($student);

        $student_info = [
            'student_id'  => $studenttb->id,
            'admin_id' => 1,
        ...
        StudentInfo::updateOrCreate($student_info);
    }
    ...
    {
        $streamId = Stream::where(['id'=>$this->eastId,'school_id'=>Auth::user()->school->id])->firstOrFail();
