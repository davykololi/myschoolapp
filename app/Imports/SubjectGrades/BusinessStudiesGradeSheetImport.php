...
{
    protected $yearId,$termId,$classId,$examId,$teacherId,$businessStudiesId;
     ...
     * @return void
     */
    public function __construct($yearId,$termId,$classId,$examId,$teacherId,$businessStudiesId)
    {
        $this->yearId = $yearId;
        $this->termId = $termId;
