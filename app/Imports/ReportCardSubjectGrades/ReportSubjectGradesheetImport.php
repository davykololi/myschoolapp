...
{
    protected $yearId,$termId,$classId,$teacherId,$mathsId,$englishId,$kiswId,$chemId,$bioId,$physicsId,$creId,$islamId,$histId,$geogId;
     ...
     * @return void
     */
    public function __construct($yearId,$termId,$classId,$teacherId,$mathsId,$englishId,$kiswId,$chemId,$bioId,$physicsId,$creId,$islamId,$histId,$geogId)
    {
        $this->yearId = $yearId;
        $this->termId = $termId;
