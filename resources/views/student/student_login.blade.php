        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <form method="POST" action="{{ route('student.login.submit') }}" id="login-form" class="white-popup-block">
                        {{ csrf_field() }}
                        <div class="login-custom">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <a title="Lost Password" href="{{ route('student.password.request') }}" class="lost-pass-link">
