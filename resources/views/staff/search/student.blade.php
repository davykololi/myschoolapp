...
@section('content') 
  ...
  <x-frontend-main>
    ...
    <div class="max-w-screen h-fit">
        ...
        <div class="w-full flex flex-col md:flex-row lg:flex-row mt-8 bg-gray-700 mx-4 md:mx-0 text-white md:rounded dark:bg-stone-500">
            <div class="w-full md:w-1/3 lg:w-1/3">
                <img class="w-full md:w-64 md:h-64 border-2 p-4 md:m-4" src="{{ $student->image_url }}" onerror="this.src='{{asset('static/avatar.png')}}'">
            </div>
            <div class="w-full md:w-2/3 lg:w-2/3 ml-4 md:ml-0">
