                ...
                <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div style="margin-bottom: 10px; width: 100%; flex-direction:;" class="uppercase col-12">
                            ...
                            <span style="text-align: right;display: inline-flex;margin-left: 120px;"><b>Class:</b> {{ $stream->name}}</span>
                        </div>
                    </div>
                    <table class="table table-bordered">
                        ...
                        @if(($mark->name === $name) && ($mark->stream->id === $stream->id) && ($mark->term->id === $term->id) && ($mark->exam->id === $exam->id) && ($mark->year->id === $year->id))
                        <tbody>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="table-left" style="border-top: 1px solid black;"><b>{{ round($mark->total,1) }}/500</b></td>
                            </tr>
                        </tfoot>
                        @endif
                        @endforeach
