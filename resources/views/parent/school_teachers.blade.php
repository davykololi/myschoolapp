                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div>
                                <a href="{{route('parent.show.teacher',$head->id)}}">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="{{route('parent.show.teacher',$deputyHead->id)}}">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="{{route('parent.show.teacher',$scienceDeptHeadTeacher->id)}}">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="{{route('parent.show.teacher',$scienceDeptAssHeadTeacher->id)}}">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="{{route('parent.show.teacher',$scienceDeptTeacher->id)}}">
