...
TAILGRIG VIDEO
    ...
    >
      ...
      <div>
        <div class="top-0 right-0 h-full w-full lg:absolute lg:w-1/2">
          <div class="flex h-full w-full items-center justify-center">
            ...
            <a
              ...
              class="absolute flex h-20 w-20 items-center justify-center rounded-full bg-primary md:h-[100px] md:w-[100px]"
            >
              <span
