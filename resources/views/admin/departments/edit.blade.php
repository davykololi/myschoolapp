    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.departments.index') }}" class="btn btn-primary pull-right">Back</a>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.departments.update', $department->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
