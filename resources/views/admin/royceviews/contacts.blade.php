...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="padding-left: 1cm;padding-right: 1cm;background-color: lightblue;">
      ...
      <form action="{{url('/admin/roycesms/contacts')}}" method="POST">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-sm-4">
            ...
            @php $count++ @endphp
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('admin/roycesms/delete',$value->id)}}" class="btn btn-sm btn-outline-danger">Delete</a>
