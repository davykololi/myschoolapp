    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.fields.index') }}" class="btn btn-primary pull-right"><i class="fas fa-angle-double-left">Back</i></a>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.fields.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
