...
<div class="container">
    <div class="row">
        <h2 class="title"><u>{{$title}}</u></h2>
            ...
            <img src="data:image/png;base64,{!! base64_encode(file_get_contents(public_path('/storage/storage/'.$student->image))) !!}" width="200px" height="200px" style="border: 5px double gray;float: right; margin-right: 37px;"> 
            @else
            <img src="data:image/png;base64,{!! base64_encode(file_get_contents(public_path('/static/avatar.png'))) !!}" width="200px" height="200px" align="right" style="border: 5px double gray; float: right;margin-right: 37px;">
            @endif     
    </div>  
    <br/>
    <div class="row">
        <div class="col-md-12" style="margin-top: 200px;">
            <div style="margin-top: 2px; margin-bottom: 10px;text-align: center;"><b><u>PERSONAL INFORMATION</u></b></div>    
            <table>
                <tbody>
                    <tr>
            ...
            <div style="margin-top: 30px; margin-bottom: 10px;text-align: center;"><b><u>ADMISSION DETAILS</u></b></div>
            <table>
                <tbody>
                    <tr>
            ...
            <div style="margin-top: 30px; margin-bottom: 10px;text-align: center;"><b><u>STUDENT STREAM SUBJECTS</u></b></div>
            <table>
                <tbody>
                    <tr>
