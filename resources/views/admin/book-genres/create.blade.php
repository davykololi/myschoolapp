...
@section('title', '| Add Book Genre')

@section('content')
@role('admin')
@can('libraryAdmin')
<x-frontend-main>
<div class="max-w-screen page-container mb-8">
    <div class="w-full">
        @include('partials.errors')
        <div class="mx-8">
            <div class="panel-heading">
                <h2 class="text-center font-bold uppercase text-2xl">Create Book Genre</h2>
            ...
            <div class="w-full mt-12">
                <form action="{{ route('admin.book-genres.store') }}" method="POST" class="w-full border rounded dark:border-slate-400 px-2 md:px-8 py-4" enctype="multipart/form-data">
                    @include('ext._csrfdiv')
                    <div class="flex flex-col md:flex-row lg:flex-row gap-2">
                        <div class="w-full md:w-1/2 lg:w-1/2">
                            <label class="" for="name">Genre</label>
                            <div class="flex-1">
