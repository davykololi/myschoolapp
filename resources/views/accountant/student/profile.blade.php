        ...
        <div class="w-full">
            <div class="-mt-8">
                <h2 class="uppercase text-center text-purple-700 font-bold text-lg dark:text-slate-400">
                    {{ $student->full_name }} Accounts Profile
                </h2>
            </div>
            <div class="w-full">
            ...
            <div>
                <form action="{{ route('accountant.payments.store') }}" method="POST" class="shadowed-border-payment" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mb-4">
                        <div class="w-full md:w-1/2 lg:w-1/2 md:mr-32">
                            <label class="label-one" >Payment Title</label>
                            <div class="input-div-one">
                                <input type="text" name="title" id="title" class="payment-input" value="{{ old('title') }}" placeholder="Title">
                            </div>
                        </div>
                        <div class="w-full md:w-1/2 lg:w-1/2 md:ml-32">
                            <label class="label-one" >Payment Description</label>
                            <div class="input-div-one">
                                <input type="text" name="description" id="description" class="payment-input" value="{{ old('description') }}" placeholder="Description">
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 mb-4">
                        <div class="w-full md:w-1/2 lg:w-1/2 md:mr-32">
                            <label class="label-one" >Payment Amount</label>
                            <div class="input-div-one">
                                <input type="text" name="amount" id="amount" class="payment-input" value="{{ old('amount') }}" placeholder="Amount">
                            </div>
                        </div>
                        <div class="w-full md:w-1/2 lg:w-1/2 md:ml-32">
                            <label class="label-one" >Refrence Number</label>
                            <div class="input-div-one">
                                <input type="text" name="ref_no" id="ref_no" class="payment-input" value="{{ old('ref_no') }}" placeholder="Reference Number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mb-4">
                        <div class="w-full md:w-1/2 lg:w-1/2 md:mr-32">
                            <label class="label-one" >Select Year</label>
                            <div class="input-div-two">
                                @include('ext._attach_yeardiv')
                            </div>
                        </div>
                        <div class="w-full md:w-1/2 lg:w-1/2 md:ml-32">
                            <label class="label-one" >Select Term</label>
                            <div class="input-div-two">
