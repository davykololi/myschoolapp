    ...
    @if(!empty($streams))
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <x-create-button>
                    <a class="bg-blue-700 text-white px-2 py-1 rounded mx-2" href="{{route('superadmin.streams.create')}}">
                    ...
                    <div class="overflow-x-auto">
                        <table class=" text-left text-sm font-light bg-gray-100 w-full mx-auto justify-evenly">
                            ...
                            @foreach($streams as $stream)
                                <tr class="border-b dark:border-neutral-500 dark:text-slate-400 dark:bg-slate-800 dark:bg-brightness-100">
