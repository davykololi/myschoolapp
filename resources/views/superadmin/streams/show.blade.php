                    ...
                    <!-- Table Headings -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <tb>
                                    <div><b>{{ $strmSubTeacher->subject->name }}</b></div>
                                </tb>
                                <tb>
                                    <div>{{ $strmSubTeacher->teacher->salutation }} {{ $strmSubTeacher->teacher->full_name }}</div>
                                </tb>
                                <tb>
                                    <div><i>{{ $strmSubTeacher->teacher->email }}</i>.<</div>
                                </tb>
                                <td>
