                    ...
                    @include('ext._csrfdiv')
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row my-4 gap-4">
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <input type="text" name="salutation" id="salutation" class="user-form-input" value="{{ $accountant->user->salutation }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >First Name</label>
                                <div class="flex flex-col">
                                    <input type="text" name="first_name" id="first_name" class="user-form-input" value="{{ $accountant->user->first_name }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Middle Name</label>
                                <div class="flex flex-col">
                                    <input type="text" name="middle_name" id="middle_name" class="user-form-input" value="{{ $accountant->user->middle_name }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Last Name</label>
                                <div class="flex flex-col">
                                    <input type="text" name="last_name" id="last_name" class="user-form-input" value="{{ $accountant->user->last_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row my-4 gap-4">
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <input type="file" name="image" id="image" class="user-form-input" value="{{ $accountant->image }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Gender Status</label>
                                <div class="flex flex-col">
                                    <input type="text" name="gender" id="gender" class="user-form-input" value="{{ $accountant->gender }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <div class="relative w-full" data-te-datepicker-init data-te-inline="true" data-te-input-wrapper-init>
                                        <input type="text" name="dob" id="dob" class="user-form-input" value="{{ $accountant->dob }}">
                                    </div>
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row my-4 gap-4">
                            <div class="w-full md:w-1/3 lg:w-1/3">
                                ...
                                <div class="flex flex-col">
                                    <input type="text" name="id_no" id="id_no" class="user-form-input" value="{{ $accountant->id_no }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Emp. No.</label>
                                <div class="flex flex-col">
                                    <input type="text" name="emp_no" id="emp_no" class="user-form-input" value="{{ $accountant->emp_no }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Designation</label>
                                <div class="flex flex-col">
                                    <input type="text" name="designation" id="designation" class="user-form-input" value="{{ $accountant->designation }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/3 lg:w-1/3">
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row my-4 gap-4">
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <input type="text" name="current_address" id="current_address" class="user-form-input" value="{{ $accountant->current_address }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Permanent Postal Address</label>
                                <div class="flex flex-col">
                                    <input type="text" name="permanent_address" id="permanent_address" class="user-form-input" value="{{ $accountant->permanent_address }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/3 lg:w-1/3">
                                <label class="control-label col-sm-2" >Email</label>
                                <div class="flex flex-col">
                                    <input type="text" name="email" id="email" class="user-form-input" value="{{ $accountant->user->email }}">
                                </div>
                            </div> 
                            <div class="w-full md:w-1/3 lg:w-1/3">
                                <label class="control-label col-sm-2" >Phone No.</label>
                                <div class="flex flex-col">
                                    <input type="text" name="phone_no" id="phone_no" class="user-form-input" value="{{ $accountant->phone_no }}" required>
                                </div>
                            </div>
                        </div>
