            ...
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0 dark:bg-stone-700 dark:text-slate-200">
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-4 bg-gray-400 dark:bg-stone-500">
                    <form action="{{ route('superadmin.librarians.update', $librarian->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row mb-8 gap-2">
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Salutation</label>
                                <div class="flex flex-col">
                                    <input type="text" name="salutation" id="salutation" class="user-form-input" value="{{ $librarian->user->salutation }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >First Name</label>
                                <div class="flex flex-col">
                                    <input type="text" name="first_name" id="first_name" class="user-form-input" value="{{ $librarian->user->first_name }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Middle Name</label>
                                <div class="flex flex-col">
                                    <input type="text" name="middle_name" id="middle_name" class="user-form-input" value="{{ $librarian->user->middle_name }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Last Name</label>
                                <div class="flex flex-col">
                                    <input type="text" name="last_name" id="last_name" class="user-form-input" value="{{ $librarian->user->last_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row mb-8 gap-2">
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <input type="file" name="image" id="image" class="user-form-input" value="{{ $librarian->image }}">
                                    @error('image')
                            ...
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <div class="relative w-full" data-te-datepicker-init data-te-inline="true" data-te-input-wrapper-init>
                                        <input type="text" name="dob" id="dob" class="user-form-input" value="{{ $librarian->dob }}">
                                    </div>
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row mb-8 gap-2">
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <input type="text" name="id_no" id="id_no" class="user-form-input" value="{{ $librarian->id_no }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Emp. No.</label>
                                <div class="flex flex-col">
                                    <input type="text" name="emp_no" id="emp_no" class="user-form-input" value="{{ $librarian->emp_no }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Designation</label>
                                <div class="flex flex-col">
                                    <input type="text" name="designation" id="designation" class="user-form-input" value="{{ $librarian->designation }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                        ...
                        <div class="w-full flex flex-col md:flex-row lg:flex-row mb-8 gap-2">   
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                ...
                                <div class="flex flex-col">
                                    <input type="text" name="current_address" id="current_address" class="user-form-input" value="{{ $librarian->current_address }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Permanent Postal Address</label>
                                <div class="flex flex-col">
                                    <input type="text" name="permanent_address" id="permanent_address" class="user-form-input" value="{{ $librarian->permanent_address }}">
                                </div>
                            </div>
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Email</label>
                                <div class="flex flex-col">
                                    <input type="text" name="email" id="email" class="user-form-input" value="{{ $librarian->user->email }}">
                                </div>
                            </div> 
                            <div class="w-full md:w-1/4 lg:w-1/4">
                                <label class="control-label col-sm-2" >Phone No.</label>
                                <div class="flex flex-col">
                                    <input type="text" name="phone_no" id="phone_no" class="user-form-input" value="{{ $librarian->phone_no }}" required>
                                </div>
                            </div>
                        </div>
