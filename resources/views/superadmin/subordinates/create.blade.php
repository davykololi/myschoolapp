...
@section('title', '| Add Subordinate Staff')
                ...
                <div class="rounded-t bg-white mb-0 px-6 py-6 dark:bg-gray-200">
                    <div class="text-center flex justify-between">
                        <h6 class="text-blueGray-700 text-xl font-bold uppercase dark:text-slate-800">
                            Subordinate Staff Registration
                        </h6>
                        <x-back-button/>
                    </div>
                </div>
                <div class="flex-auto px-4 lg:px-10 py-10 pt-4 bg-gray-400 dark:bg-stone-500">
                    <form action="{{ route('superadmin.subordinates.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="w-full lg:w-12/12 px-2">
                                <div class="relative w-full mb-3">
                                    <label class="form-input-label-one" htmlfor="grid-password">
                                        More Information About Subordinade Staff
                                    </label>
