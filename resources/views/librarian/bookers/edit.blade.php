                ...
                <form action="{{ route('librarian.bookers.update', $booker->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col md:flex-row gap-2 md:mb-4">
                        ...
                        <div class="w-full md:w-1/3 lg:1/3 md:mx-4">
                            ...
                            <div class="block">
                                <input type="text" name="serial_no" id="serial_no" class="lib-form-input" value="{{$booker->serial_no}}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-full md:w-1/3 lg:1/3 md:mx-4">
                            ...
                            <div class="block">
                                <div class="relative w-full" data-te-datepicker-init data-te-inline="true" data-te-input-wrapper-init>
                                    <input type="text" name="issued_date" id="issued_date" class="lib-form-input" value="{{$booker->issued_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-1/3 lg:1/3 md:mx-4">
                            ...
                            <div class="block">
                                <div class="relative w-full" data-te-datepicker-init data-te-inline="true" data-te-input-wrapper-init>
                                    <input type="text" name="return_date" id="return_date" class="lib-form-input" value="{{$booker->return_date}}">
                                </div>
                            </div>
                        </div>
                        <div>
                            <input type="hidden" name="status_returned" id="status_returned" value="{{$booker->returned_status ? 'Good':'Poor'}}">
                        </div>
                        <div class="w-full md:w-1/3 lg:1/3 md:mx-4">
                            <label class="" >Recommendation</label>
                            <div class="block">
                                <input type="text" name="recommentation" id="recommentation" class="lib-form-input" value="{{$booker->recommentation}}">
                            </div>
                        </div>
                    </div>
                    <div class="mx-4 mt-4">
