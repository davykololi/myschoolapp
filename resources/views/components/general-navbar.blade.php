<nav class="border-b bg-[#1638A1] border-gray-200 sticky top-0 z-10 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
      <ul class="flex flex-col font-bold p-4 md:p-0 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-stone-500 dark:border-gray-700 text-sm">
        <li>
          <x-general-sidenav-toggler/>
        </li>
        <li>
          <div id="real-time-clock" class="py-2"></div>
        </li>
        <li class="mt-2">
