<nav class="border-b bg-white border-gray-200 sticky top-0 z-10 dark:bg-gray-900 dark:text-slate-600">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 dark:text-slate-400">
      <li>
        <x-teacher-sidenav-toggler/>
      </li>
      <li>
                  ...
                  <li aria-labelledby="dropdownNavbarLink">
                    ...
                    <div id="doubleDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton">
                          ...
                          <li>
                            <a href="{{ route('teacher.assignments.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Assignments</a>
                          </li>
                          <li>
                            <a href="{{ route('teacher.school.teachers') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Teachers</a>
                          </li>
                          <li>
                            <a href="{{ route('teacher.streams') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Streams</a>
                          </li>
                          <li>
                            <a href="{{ route('teacher.departments') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Departments</a>
                          </li>
                        </ul>
                    </div>
                  </li>
