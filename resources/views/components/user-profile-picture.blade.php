...
<img class="user-profile-picture" src="/storage/storage/{{Auth::user()->student->image }}" onerror="this.src='{{asset('static/avatar.png')}}'">
@elseif(Auth::user()->hasRole('student') && Auth::user()->gender === "Female")
<img class="user-profile-picture" src="/storage/storage/{{Auth::user()->student->image }}" onerror="this.src='{{asset('static/female_avatar.png')}}'">
@endif
