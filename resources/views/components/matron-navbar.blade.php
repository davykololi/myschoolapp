                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="{{route('matron.dormitories',Auth::user()->school->id)}}">DORMITORIES</a>
                        </li>
                    </ul>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('matron.profile') }}">Profile</a>
                                    <a class="dropdown-item" href="{{route('matron.change-password.form')}}">Change Password </a>
