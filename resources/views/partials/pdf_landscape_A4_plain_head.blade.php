<head>
    ...
    <style>
        ...
        #landscape_logo{position: fixed;bottom:15cm;left:10.5cm;top:6cm;width:8cm;height:8cm;z-index: -10;opacity: .2;}
        .landscape_hr_top{width: 91%;border-top: 10px groove brown;margin-top: 5px;}
        ...
        .table-footer{background-color: purple;color: white;font-family: Times New Roman;}
