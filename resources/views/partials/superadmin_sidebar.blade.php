									...
									<li>
										...
										<div class="collapse" id="subnav1">
											<ul class="nav nav-collapse subnav">
												...
												<li>
													<a href="{{ route('superadmin.stream-sections.index') }}">
														<span class="sub-item">STREAM SECTIONS</span>
													</a>
												</li>
												<li>
													<a href="{{ route('superadmin.years.index') }}">
												...
												<li>
													<a href="{{ route('superadmin.librarians.index') }}">
														<span class="sub-item">LIBRARIANS</span>
													</a>
												</li>
												<li>
													<a href="{{ route('superadmin.accountants.index') }}">
														<span class="sub-item">ACCOUNTANTS</span>
													</a>
												</li>
												<li>
