<footer>
	...
	<p style="text-align: left;margin-left: 110px;margin-right: 110px;font-size: 16px;width: 100%;">
		...
		<span class="pull-right"><b>Year:</b> <i>{{ date('Y') }}</i></span>
	</p>
	<img src="data:image/png;base64,{!! base64_encode(QrCode::size(80)->generate($title)) !!}" align="right" style="margin-right: 112px; margin-top: -50px;">
</footer>