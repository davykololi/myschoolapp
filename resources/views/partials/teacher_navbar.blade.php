            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('teacher.school.teachers') }}">TEACHERS</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('teacher.streams') }}">STREAMS</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('teacher.departments') }}">DEPARTMENTS</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('teacher.rewards') }}">AWARDS</a>
                        </li>
                        <li class="nav-item active">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{route('teacher.change-password.form')}}">Change Password</a>
