<head>
    ...
    <style>
        ...
        #landscape_logo{position: fixed;bottom:15cm;left:10cm;top:6cm ;width:8cm;height:8cm;opacity: 0.2;z-index: -10px;}
        .landscape_hr_top{width: 82%;border-top: 10px groove brown;margin-top: 8px;}
