<header>
	<img src="data:image/png;base64,{!! base64_encode(file_get_contents(public_path('/storage/storage/'.Auth::user()->school->image))) !!}" width="120px" height="120px" align="left" style="margin-left: 100px;margin-right: auto;margin-top: 22px;">
