...
<div class="container mt-8 mb-24 mx-auto md:px-6">
  ...
  <section class="mb-32 text-center">
    <h2 class="mb-32 text-3xl font-bold">
      MEET THE <u class="text-primary dark:text-primary-400">TEACHERS</u>
    </h2>
    <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      ...
      <div class="mb-24 ">
        <div
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-bold">{{ $teacher->user->full_name }}</h5>
            <p class="mb-6">{{ $teacher->position->value }}</p>
