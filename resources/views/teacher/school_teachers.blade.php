...
<div class="container my-4 mx-auto md:px-6">
  ...
  <section class="mb-32 text-center">
    <h2 class="mb-12 text-3xl font-bold uppercase">
...
<span class="material-icons">cancel</span>
    ...
    @if(!empty(\Auth::user()->school->teachers))
    @foreach(\Auth::user()->school->teachers as $teacher)
      <div class="mb-4">
        <div
          class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div class="relative overflow-hidden bg-cover bg-no-repeat">
            <img src="{{ $teacher->image_url }}" onerror="this.src='{{asset('static/avatar.png')}}'" class="w-full rounded-t-lg" />
            <a href="#!">
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-bold">{{ $teacher->full_name}}</h5>
  ...
  <section class="mb-32 text-center">
    ...
    <div class="lg:gap-xl-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
      <div class="mb-12 lg:mb-0">
        <img class="mx-auto mb-6 rounded-lg shadow-lg dark:shadow-black/20 w-[150px]" src="{{ asset('static/avatarb.jpg')}}" alt="avatar" />
