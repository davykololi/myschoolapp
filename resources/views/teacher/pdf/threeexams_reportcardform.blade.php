...
@section('title', '| Teacher Three Exams Report Card Form')
...
<div class="max-w-screen page-container">
    <div class="w-full">
        <div class="mx-2 md:mx-8 lg:mx-8">
            ...
            <div class="py-2 flex flex-col md:flex-row gap-2 md:gap-4 mb-2">
                <div class="w-full md:w-1/3 lg:w-1/3">
                    <form action="{{ route('teacher.threeexams.reportcardSettings') }}" class="shadowed-border" method="post">
                        {{ csrf_field() }}
                ...
                <div class="w-full md:w-1/3 lg:w-1/3">
                    <form action="{{ route('teacher.threeexams.classtotals') }}" class="shadowed-border" method="post">
                        {{ csrf_field() }}
                ...
                <div class="w-full md:w-1/3 lg:w-1/3">
                    <form id="marksheets_form" action="{{ route('teacher.threeexams.streamtotals') }}" class="shadowed-border" method="post">
                        {{ csrf_field() }}
            ...
            <div class="py-4 justify-evenly">
                <form id="marksheets_form" action="{{ route('teacher.threeexams.reportcard') }}" class="shadowed-border" method="get" enctype="multipart/form-data">
                    {{ csrf_field() }}
